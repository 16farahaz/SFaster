 ...
 */
final class Version20210617002451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_o ADD CONSTRAINT FK_6A3006E27F2DEE08 FOREIGN KEY (facture_id) REFERENCES facture (id)');
        $this->addSql('ALTER TABLE form_data_demande_o ADD CONSTRAINT FK_535ABDAE699C107 FOREIGN KEY (form_data_id) REFERENCES form_data (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE form_data_demande_o ADD CONSTRAINT FK_535ABDAEBCA456BE FOREIGN KEY (demande_o_id) REFERENCES demande_o (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_o DROP FOREIGN KEY FK_6A3006E27F2DEE08');
        $this->addSql('ALTER TABLE form_data_demande_o DROP FOREIGN KEY FK_535ABDAE699C107');
        $this->addSql('ALTER TABLE form_data_demande_o DROP FOREIGN KEY FK_535ABDAEBCA456BE');
